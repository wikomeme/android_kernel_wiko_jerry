...
#if defined(CONFIG_PROJECT_V2800_MMX_IN)
#define KPOC_USB_VENDOR_ID 0x2A96
#else
...
#if defined(CONFIG_PROJECT_V2800_CLF_PH)
#define MANUFACTURER_STRING "CloudFone"
#define PRODUCT_STRING "Thrill Lite"

#elif defined(CONFIG_PROJECT_V2800_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "QMobile i6 Metal ONE"

#elif defined(CONFIG_PROJECT_V2500_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "QMobile X32"

#elif defined(CONFIG_PROJECT_V2500_MMX_IN_4)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q303"

#elif defined(CONFIG_PROJECT_V2500_WIK_FR) || defined (CONFIG_PROJECT_V2504_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "SUNNY"

#elif defined(CONFIG_PROJECT_V2500_MMX_IN_8)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q304"

#elif defined(CONFIG_PROJECT_V2800_BLU_US)
#define MANUFACTURER_STRING "BLU"
#define PRODUCT_STRING "Dash M2"

#elif defined(CONFIG_PROJECT_V2800_HYC_KH)
#define MANUFACTURER_STRING "HIYA"
#define PRODUCT_STRING "7 Ace"

#elif defined(CONFIG_PROJECT_V3702_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "QMobile i6 Metal HD"

#elif defined(CONFIG_PROJECT_V3750_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "QMobile S2 Plus"

#elif defined(CONFIG_PROJECT_P4200_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "QMobile S2 Pro"

#elif defined(CONFIG_PROJECT_V3702_BLU_US)
#define MANUFACTURER_STRING "BLU"
#define PRODUCT_STRING "Dash X2"

#elif defined(CONFIG_PROJECT_V3702_CLF_PH)
#define MANUFACTURER_STRING "Thrill HD"
#define PRODUCT_STRING "Thrill HD"
#elif defined(CONFIG_PROJECT_V3750_CLF_PH)
#define MANUFACTURER_STRING "CloudFone"
#define PRODUCT_STRING "Thrill Plus 16GB"

#elif defined(CONFIG_PROJECT_P4200_CLF_PH)
#define MANUFACTURER_STRING "CloudFone"
#define PRODUCT_STRING "Thrill Snap"

#elif defined(CONFIG_PROJECT_V3702_KNB_MM)
#define MANUFACTURER_STRING "KENBO"
#define PRODUCT_STRING "E91"

#elif defined(CONFIG_PROJECT_V3702_HYC_KH)
#define MANUFACTURER_STRING "Hiya"
#define PRODUCT_STRING "K Pop"

#elif defined(CONFIG_PROJECT_V3702_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "LENNY3"

#elif defined(CONFIG_PROJECT_V3750_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "ROBBY"
#define PRODUCT_STRING_AFRICA "ROBBY"

#elif defined(CONFIG_PROJECT_V3702_BQ_RU)
#define MANUFACTURER_STRING "BQS-5020"
#define PRODUCT_STRING "Strike"
#define PRODUCT_STRING_AFRICA "Strike"

#elif defined(CONFIG_PROJECT_P4200_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "FREDDY"

#elif defined(CONFIG_PROJECT_V2800_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "K-KOOL"

#elif defined(CONFIG_PROJECT_V2802_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "JERRY"

#elif defined(CONFIG_PROJECT_V2800_MMX_IN)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q350"

#elif defined(CONFIG_PROJECT_V3702_MMX_IN)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q352"

#elif defined(CONFIG_PROJECT_P4200_MMX_IN)
#define MANUFACTURER_STRING "Micromax"
#define PRODUCT_STRING "Q349"

#elif defined(CONFIG_PROJECT_V2800_SYM_BD)
#define MANUFACTURER_STRING ""
#define PRODUCT_STRING "V75"

#elif defined(CONFIG_PROJECT_P4200_SYM_BD)
#define MANUFACTURER_STRING ""
#define PRODUCT_STRING "i10"

#elif defined(CONFIG_PROJECT_V2800_KNB_MM)
#define MANUFACTURER_STRING "KENBO"
#define PRODUCT_STRING "E81"

#elif defined(CONFIG_PROJECT_P4200_TRUNK)
#define MANUFACTURER_STRING ""
#define PRODUCT_STRING "P4200"

#elif defined(CONFIG_PROJECT_V2500_BLU_US)
#define MANUFACTURER_STRING "BLU"
#define PRODUCT_STRING "ADVANCE 4.0 L2"

#elif defined(CONFIG_PROJECT_V2800_LAX_TEL_MX ) || defined (CONFIG_PROJECT_V2800_LAX_CLA_CO)
#define MANUFACTURER_STRING "LANIX"
#define PRODUCT_STRING "Ilium X510"

#elif defined(CONFIG_PROJECT_V3750_LAX_TEL_MX)
#define MANUFACTURER_STRING "LANIX"
#define PRODUCT_STRING "Ilium X710"

#elif defined(CONFIG_PROJECT_V3750_WAL_BD)
#define MANUFACTURER_STRING "WALTON"
#define PRODUCT_STRING "Primo N2"

#elif defined(CONFIG_PROJECT_V2800AN_ZA)
#define MANUFACTURER_STRING "PURE"
#define PRODUCT_STRING "MOBICEL PURE"

#elif defined(CONFIG_PROJECT_V2800AN_MTN_ZA)
#define MANUFACTURER_STRING "TREDNY"
#define PRODUCT_STRING "MOBICEL TREDNY"

#elif defined(CONFIG_PROJECT_V2502_MCL_MTN_ZA)
#define MANUFACTURER_STRING "Mobicel"
#define PRODUCT_STRING "Candy"

#elif defined(CONFIG_PROJECT_V2800_OYS_RU)
#define MANUFACTURER_STRING "Oysters"
#define PRODUCT_STRING "PacificE"

#elif defined(PROJECT_EVERSTAR_PRO)
#define MANUFACTURER_STRING "EVERTEK"
#define PRODUCT_STRING "EverStar Pro"
...
#if defined(CONFIG_PROJECT_V2500_WIK_FR) || defined (CONFIG_PROJECT_V2504_WIK_FR)
    /* Default strings - should be updated by userspace */   
    if((!strncmp(Market_Area, "EU", strlen("EU"))) || (!strncmp(Market_Area, "TH", strlen("TH"))))
    {
        strncpy(manufacturer_string, "WIKO", sizeof(manufacturer_string) - 1);
	    strncpy(product_string, "SUNNY", sizeof(product_string) - 1);
    }
    else if((!strncmp(Market_Area, "DU", strlen("DU"))) 
        || (!strncmp(Market_Area, "ID", strlen("ID"))) 
        || (!strncmp(Market_Area, "VN", strlen("VN"))))
    {
        strncpy(manufacturer_string, "WIKO", sizeof(manufacturer_string) - 1);
	    strncpy(product_string, "B-KOOL", sizeof(product_string) - 1);
    }
    else
#elif defined(CONFIG_PROJECT_V3750_WIK_FR)
	if((!strncmp(Market_Area, "EU", strlen("EU"))) || (!strncmp(Market_Area, "ID", strlen("ID"))))
    {
        ...
        || (!strncmp(Market_Area, "VN", strlen("VN"))) 
        || (!strncmp(Market_Area, "TH", strlen("TH"))))
    {
        strncpy(manufacturer_string, MANUFACTURER_STRING, sizeof(manufacturer_string) - 1);
	    strncpy(product_string, PRODUCT_STRING_AFRICA, sizeof(product_string) - 1);
    }
    else
#endif
#endif
